...
const HeaderNew = () => {
  ...
  useEffect(() => {
    axios.get(`mega-menu-items`).then((res) => {
    ...
    axios.get(`news-pages-media`).then((res) => {
      ...
      <nav className="navbar navbar-expand-lg bg__body navbar-dark">
        <div className="container container-fluid ht__navbar__logo">
          ...
          >
            ...
            <ul className="navbar-nav menu3 flex-wrap">
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <span>
                    New media <i className="fa-solid fa-angle-down pl-2"></i>
                  </span>
                </Link>
                <div
                  className="dropdown-menu drop__services"
                                  ...
                                  item.subPages
                                    ...
                                    .map((sub, i) => {
                                      return (
                                        <Link
                                          key={i}
                                          to={`news-media-sub-details/${sub.id}`}
                                          className="dropdown-item"
                                        >
                                          <span>
                                            <div className="ps-2">
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        display: "grid",
                        gridTemplateColumns: `repeat(${item?.grid_col}, 1fr)`,
                      }}
                    >
                      {item?.children?.length > 0 &&
                        item.children
