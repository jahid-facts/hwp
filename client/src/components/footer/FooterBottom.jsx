  ...
  return (
    <div className="pt-0" style={{ background: "#e9edf1" }}>
      <div className="container  p-lg-0">
        <div className="mb-2 footer-button-section text-center py-2">
        ...
        <div className="row g-3">
          ...
          <div className="col-md-4">
            ...
            >
              <div>
                <h6 className="fb__link__txt m-0">সামাজিক যোগাযোগ</h6>
              </div>
      ...
      {/* <div style={{ borderTop: "2px dotted #800000" }} /> */}

      <div className="container p-lg-0" style={{ borderTop: "2px dotted #800000" }}>
        <div className="d-md-flex justify-content-between ft__copyright pb-3">
          <p className=" mb-0">
            {" "}
            <span className="me-3">
              <span className="me-3">
