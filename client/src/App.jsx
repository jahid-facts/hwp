...
import NewsMediaDetails from "./components/news-media/NewsMediaDetails.jsx";
import NewsMediaSubmenuDetails from "./components/news-media/NewsMediaSubmenuDetails.jsx";
import MenuPostDetails from "./components/MenuPostDetails.jsx";
import PostPageDetails from "./components/news-media/PostPageDetails.jsx";
import PostSubPageDetails from "./components/news-media/PostSubPageDetails.jsx";
    ...
    <div style={{ backgroundColor: data?.content }}>
      <Routes>
        <Route path="/" element={<Layouts />}>
          ...
          <Route path="post-details/:id" element={<MenuPostDetails />}></Route>
          {/* unit  */}
          ...
          <Route path="post-page-details/:id" element={<PostPageDetails />}></Route>
          <Route path="post-sub-page-details/:id" element={<PostSubPageDetails />}></Route>
          <Route
            path="news-media-sub-details/:id"
            element={<NewsMediaSubmenuDetails />}
          ></Route>
          <Route
            path="news-media-details/:id"
            element={<NewsMediaDetails />}
          ></Route>
          <Route
