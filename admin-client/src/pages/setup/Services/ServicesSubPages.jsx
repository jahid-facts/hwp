...
export default function ServicesSubPages() {
  ...
  const deleteRowData = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        http.delete(`delete-services-sub-pages/${id}`).then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          Swal.fire({
            position: "top-center",
  ...
  const submitData = (e) => {
    ...
    if (categoryData.id) {
      http
        .put(`update-services-sub-pages/${categoryData.id}`, formData)
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
      ...
      http
        .post("save-services-sub-pages", formData)
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          setContent("");
