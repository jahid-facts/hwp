...
export default function Sp() {
  ...
  const submitData = (e) => {
    ...
    if (activityData.id) {
      http
        .put(`update-police-super/${activityData.id}`, formData)
        .then((res) => {
          setUpdate(!update);
          closeModal();
          Swal.fire({
      ...
      http
        .post("save-police-super", formData)
        .then((res) => {
          setUpdate(!update);
          closeModal();
          Swal.fire({
  ...
  const deleteRowData = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        http.delete(`delete-police-super/${id}`).then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          Swal.fire({
            position: "top-center",
            ...
            <div className="page-content">
              ...
              <div className=" p-3">
                <form onSubmit={submitData}>
                  ...
                  <input
                    onChange={handleChange}
                    value={activityData.designation}
                    name="designation"
                    type="text"
                    className="form-control form-control-sm my-2"
                    required
