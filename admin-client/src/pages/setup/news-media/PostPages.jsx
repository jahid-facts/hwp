...
export default function NewsMediaPagesPost() {
  ...
  const deleteRowData = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        http.delete(`delete-news-pages-post/${id}`).then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          Swal.fire({
            position: "top-center",
  ...
  const submitData = (e) => {
    ...
    if (categoryData.id) {
      http
        .put(`update-news-pages-post/${categoryData.id}`, formData)
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
      ...
      http
        .post("save-news-pages-post", formData)
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          setContent("");
