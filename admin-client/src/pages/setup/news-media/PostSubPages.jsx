...
// export default function NewsMediaSubPagesPost() {
...
//         http.delete(`delete-news-sub-pages-post/${id}`).then((res) => {
//           setUpdate(!update);
//           setIsOpen(false);
//           Swal.fire({
//             position: "top-center",
...
//     {
//       title: "Page",
//       render: (row) => <div>{row?.page?.title}</div>,
//       cellStyle: {
//         textAlign: "center",
//       },
//     },
...
//     if (categoryData.id) {
//       http
//         .put(`update-news-sub-pages-post/${categoryData.id}`, formData)
//         .then((res) => {
//           setUpdate(!update);
//           setIsOpen(false);
...
//     } else {
//       http
//         .post("save-news-sub-pages-post", formData)
//         .then((res) => {
//           setUpdate(!update);
//           setIsOpen(false);
//           setContent("");
...
//         <h6>News Media Sub Pages Post</h6>
...
export default function NewsMediaSubPagesPost() {
  ...
  const columns = [
    ...
    {
      title: "Page",
      render: (row) => <div>{row?.newsSubPages?.title}</div>,
      cellStyle: {
        textAlign: "center",
      },
    },
  ...
  const submitData = (e) => {
    ...
    formData.append("pageId", categoryData.pageId);
    ...
    if (categoryData.id) {
      http
        ...
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          setPagesData({ title: "", pageId: "", file: "" });
          setContent("");
          Swal.fire({
            position: "top-center",
            icon: "success",
          ...
          <div className="page-content">
            ...
            <div className=" p-3">
              <form onSubmit={submitData}>
                ...
                <input
                  onChange={(e) =>
                    setPagesData({ ...categoryData, file: e.target.files[0] })
                  }
                  name="file"
                  type="file"
                  required={!categoryData?.id}
                  className="form-control form-control-sm my-2"
                />
