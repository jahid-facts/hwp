...
export default function NewsMediaSubPages() {
  ...
  const deleteRowData = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        http.delete(`delete-news-media-sub-pages/${id}`).then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          Swal.fire({
            position: "top-center",
  ...
  const submitData = (e) => {
    ...
    if (categoryData.id) {
      http
        .put(`update-news-media-sub-pages/${categoryData.id}`, formData)
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
      ...
      http
        .post("save-news-media-sub-pages", formData)
        .then((res) => {
          setUpdate(!update);
          setIsOpen(false);
          setContent("");
