...
import MegaMenu from "../pages/setup/megaMenu/MegaMenuPages";
import NewsMediaSubPages from "../pages/setup/news-media/NewsMediaSubPages";
import NewsMediaPages from "../pages/setup/news-media/NewsMediaPages";
import NewsMediaPagesPost from "../pages/setup/news-media/PostPages";
import NewsMediaSubPagesPost from "../pages/setup/news-media/PostSubPages";
import RecentActivityRole from "../pages/setup/Recent Activity/RecentActivityRole";
...
const Auth = () => {
  ...
  useEffect(() => {
    http.get(`users/${user.id}`).then((res) => {
      const { home_page, administration, service, user, activity } =
        res.data?.role;
      setUserRole({
      ...
      <div className="main-wrapper">
        ...
        <div className="page-wrapper">
          ...
          <Routes>
            ...
            ) : userRole.activity.length > 0 ? (
              <Route path="/" element={<RecentActivityRole />} />
            ) : (
              <Route
                path="/"
                element={
            ...
            {userRole.administration.length > 0 && (
              <>
                ...
                />
                <Route path="/news-media-pages" element={<NewsMediaPages />} />
                <Route path="/news-media-pages-post" element={<NewsMediaPagesPost />} />
                <Route
                  path="/news-media-sub-pages"
                  element={<NewsMediaSubPages />}
                />
                <Route
                  path="/news-media-sub-pages-post"
                  element={<NewsMediaSubPagesPost />}
                />
            ...
            {userRole.activity.length > 0 && (
              <Route path="/recent-activity" element={<RecentActivityRole />} />
            )}
