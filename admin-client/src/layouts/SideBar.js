          ...
          <ul className="nav">
            ...
            {userRole.home_page.length > 0 && (
              <>
                <li
                  class={`nav-item ${
                    location.pathname === "/mega-menu" ? "active" : ""
                  }`}
                >
                  <a
                    class="nav-link"
                    ...
                    role="button"
                    aria-expanded={`${
                      location.pathname === "/mega-menu" ? "true" : ""
                    }`}
                    aria-controls="user"
                  >
                    <FiUnlock className="link-icon" />
                    <span class="link-title">Mega menu</span>
                    <FiChevronDown className="link-arrow" />
                  </a>
                  <div
                    class={`collapse ${
                      location.pathname === "/mega-menu" ? "show" : ""
                    }`}
                    id="user"
                  >
            ...
            {userRole.administration.length > 0 && (
              <>
                ...
                <li
                  class={`nav-item ${
                    location.pathname === "/news-media-pages" ||
                    location.pathname === "/news-media-sub-pages"
                      ? "active"
                      : ""
                  }`}
                >
                  ...
                  <div
                    class={`collapse ${
                      location.pathname === "/news-media-pages" ||
                      location.pathname === "/news-media-pages-post" ||
                      location.pathname === "/news-media-sub-pages-post" ||
                      location.pathname === "/news-media-sub-pages"
                        ? "show"
                        : ""
                    }`}
