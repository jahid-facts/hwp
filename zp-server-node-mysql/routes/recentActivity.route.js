...
const { getActivity,saveActivity,getSingleActivity,updateActivity,deleteActivity, getActivityUser } = require('../controllers/recentActivityController');
const router = express.Router();

router.get('/recent-activity', getActivity);
router.get('/recent-activity-user/:id', getActivityUser);
